...
<!-----Breadcrumb------->
<section class="breadcrumb pt-50 pb-50">
            ...
            <div class="col-lg-9 mx-0 px-0">
                ...
                <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="#">Toyota Camry New</a></li>
                      </ol>
                 </nav>

                  <div class="heading d-flex align-content-center">Toyota Camry New <span class="tag2">MUV</span></div>
    ...
    <div class="ag-photo-gallery_list">
      <div class="ag-photo-gallery_item ag-photo-gallery_item__wide">
        <figure class="ag-photo-gallery_figure">
          <a href="https://raw.githack.com/SochavaAG/example-mycode/master/pens/1_images/img-1098x549-6.jpg" data-fancybox="gallery" data-caption="Car 1">
      ...
      <div class="ag-photo-gallery_item ag-photo-gallery_item__narrow">
        <figure class="ag-photo-gallery_figure">
          <a href="https://raw.githack.com/SochavaAG/example-mycode/master/pens/1_images/img-1098x549-2.jpg" data-fancybox="gallery" data-caption="Car 2">
       ...
       <div class="ag-photo-gallery_item ag-photo-gallery_item__narrow">
        <figure class="ag-photo-gallery_figure">
          <a href="https://raw.githack.com/SochavaAG/example-mycode/master/pens/1_images/img-1098x549-9.jpg" data-fancybox="gallery" data-caption="Car 3">
       ...
       <div class="ag-photo-gallery_item ag-photo-gallery_item__narrow">
        <figure class="ag-photo-gallery_figure">
          <a href="https://raw.githack.com/SochavaAG/example-mycode/master/pens/1_images/img-1098x549-4.jpg" data-fancybox="gallery" data-caption="Car 4">
       ...
       <div class="ag-photo-gallery_item ag-photo-gallery_item__narrow">
        <figure class="ag-photo-gallery_figure">
          <a href="https://raw.githack.com/SochavaAG/example-mycode/master/pens/1_images/img-1098x549-5.jpg" data-fancybox="gallery" data-caption="Car 5">
        ...
        <div class="container">
              ...
              <div class="row border-r">
               <div class="col-lg-12  d-flex justify-content-between pt-0 pb-0">
                ...
                <div class=""><h2 class="car-overv pt-0" car="" overview="">Complete Car Auction History:</h2></div>
                ...
                <div class="car-modal tag">MUV</div> 
                 <div class="product-img-box">
                  <img class="w-100" src="assets/images/product/product-1.jpg" alt="">
                   <div class="car-value tag">Estimated Market Value: $<span class="">30,000</span></div> 
                 </div>
