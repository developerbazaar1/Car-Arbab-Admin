    ...
    <div class="app app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input type="email" class="form-control m-b-md" id="signUpEmail" aria-describedby="signUpEmail" placeholder="example@rentaly.com">
            ...
            <div class="auth-submit">
                <a href="dashboard.php" class="btn btn-primary">Sign Up</a>
            </div>
