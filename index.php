  ...
  <div class="container">
    <div class="row">
       <div class="col-lg-5  animated wow fadeInLeft ">
          ...
          <p class="hero-pera">Elevate your drive with Website Name. Explore diverse car auctions, bid, and win your dream ride. Unleash the thrill – start now!</p>
...
<section>
    ...
    <button id="" type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
      Make
    </button>
...
<div class="at"> 
      ...
      <label class="btn btn-outline-primary" for="btncheck4">Warranty Available</label>
  </div>


        <div class="at"> 
       <input type="checkbox" class="btn-check" id="btncheck5" autocomplete="off">
      <label class="btn btn-outline-primary" for="btncheck5">Bank Loan Available</label>
  </div>
...
<i class="button--right fa-solid fa-chevron-right" id="slide"></i>
 ...
 <div class="col-lg-12 mt-50 mx-auto text-center"><button class="btn-load-more"><i class="fa-solid fa-spinner"></i> &nbsp;  More </button></div>
</div><!----/Row----->
 ...
 <div class="container">
    <div class="row mx-auto">
          ...
          <div class="col-lg-2 col-sm-2 col-xs-6 mx-auto text-center hv">
                 <div class="ico-b d-flex justify-content-center align-items-center mb-35"><img class="" src="assets/images/icon/step1.png"></div> 
          ...
          <div class="col-lg-2 col-sm-2 col-xs-6 mx-auto text-center hv">
                   ...
                   <div class="explore">Secure Participation</div>
                    ...
                    <div class="ico-b d-flex justify-content-center align-items-center mt-35"><img class="" src="assets/images/icon/step2.png"></div> 
         </div>

          <div class="col-lg-2 col-sm-2 col-xs-6 mx-auto text-center hv">
                 <div class="ico-b d-flex justify-content-center align-items-center mb-35"><img class="" src="assets/images/icon/step3.png"></div> 
          ...
          <div class="col-lg-2 col-sm-2 col-xs-6 mx-auto text-center hv">
                  ...
                  <div class="step mt-90"> Step:4</div>
                   ...
                   <div class="ico-b d-flex justify-content-center align-items-center mt-35"><img class="" src="assets/images/icon/step4.png"></div>

         </div>  

          <div class="col-lg-2 col-sm-2 col-xs-6 mx-auto text-center hv">
                 <div class="ico-b d-flex justify-content-center align-items-center mb-35"><img class="" src="assets/images/icon/step5.png"></div> 
...
<div class="row mx-0 px-0 mx-auto">
    ...
    <div class="col-lg-6 mx-0 px-0">
            ...
            <p class="section-pera">We have been using Rentaly for our trips needs for several years now and have always been happy with their service. Their customer support is Excellent Service! and they are always available to help with any issues we have. Their prices are also very competitive.</p>
